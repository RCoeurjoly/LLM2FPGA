...
EOF
        ...
        task6Pcie7xSourceVivadoLane0LocRowstreamIngress =
          pkgs.runCommand "task6-pcie7x-source-vivado-lane0-loc-rowstream-ingress" { nativeBuildInputs = [ pkgs.python3 ]; } ''
            set -euo pipefail
            cp -r ${task6Pcie7xSourceVivadoLane0Loc} "$out"
            chmod -R u+w "$out"
            python3 ${./scripts/task6/patch_pcie_rowstream_ingress_source.py} "$out/src/aximm-minimal/pcie_7x_top_aximm.v"
          '';
        ...
        task6YpcbPcieRowstreamIngressM25AttentionLn2YosysJson =
          pkgs.runCommand "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-yosys.json" {
            buildInputs = [ yosysPkg ];
          } ''
            set -euo pipefail
            cat > run.ys <<EOF
        ...
        task6YpcbPcieDdr3IsolatedCommandBridgeYosysJson =
          pkgs.runCommand "task6-ypcb-pcie-ddr3-isolated-command-bridge-yosys.json" {
            ...
            read_verilog -sv -DTASK6_PCIE_ROWSTREAM_INGRESS_PORTS \
              ...
              ${./fpga/rtl/task6_ypcb_pcie_ddr3_isolated_command_bridge_top.sv}
            hierarchy -top task6_ypcb_pcie_ddr3_isolated_command_bridge_top -check
            synth_xilinx -flatten -arch xc7 -nosrl -noiopad -top task6_ypcb_pcie_ddr3_isolated_command_bridge_top
            stat -top task6_ypcb_pcie_ddr3_isolated_command_bridge_top
            write_json "$out"
            EOF
            yosys -s run.ys
          '';
        ...
        task6YpcbUberDdr3BistYosysJson =
          mkTask6YpcbUberDdr3BistYosysJson { };
        task6YpcbUberDdr3Bist1LaneYosysJson =
          mkTask6YpcbUberDdr3BistYosysJson {
        ...
        task6YpcbUberDdr3RowstreamLoaderBistClockYosysJson =
          mkTask6YpcbUberDdr3RowstreamLoaderYosysJson {
            name = "task6-ypcb-uberddr3-rowstream-loader-bist-clock-yosys.json";
            byteLanes = 1;
            pllClkout0Divide = 10;
            pllClkout1Divide = 10;
            pllClkout2Divide = 40;
        ...
        task6TinyStories1mM2AttentionLoweringScore =
          pkgs.runCommand "task6-tinystories-1m-m2-attention-lowering-score" { } ''
            mkdir -p "$out"
            ${pkgs.python3}/bin/python3 ${
              ./scripts/task6/score_m2_ln1_qkv_lowering.py
            } \
        ...
        task6TinyStories1mM2MlpResidualLoweringScore =
          pkgs.runCommand "task6-tinystories-1m-m2-mlp-residual-lowering-score" { } ''
            mkdir -p "$out"
            ${pkgs.python3}/bin/python3 ${
              ./scripts/task6/score_m2_mlp_residual_lowering.py
            } \
              --contract-manifest ${task6TinyStories1mM2OneBlockContract}/manifest.json \
              --weight-manifest ${task6TinyStories1mM2OneBlockInt8WeightPack}/manifest.json \
        ...
        task6YpcbPcieRowstreamIngressDummyFasm = mkFasm {
          name = "task6-ypcb-pcie-rowstream-ingress-dummy";
          xdc = "${task6Pcie7xSourceVivadoLane0Loc}/pcie_7x_ypcb_k480t.xdc";
        ...
        task6YpcbPcieRowstreamIngressDummyBitstream = mkBitstream {
          name = "task6-ypcb-pcie-rowstream-ingress-dummy";
          fasm = task6YpcbPcieRowstreamIngressDummyFasm;
        ...
        task6YpcbPcieRowstreamIngressM25AttentionLn2Pnr100Fasm = mkFasm {
          name = "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-pnr100";
          xdc = "${task6Pcie7xSourceVivadoLane0Loc}/pcie_7x_ypcb_k480t.xdc";
          json = task6YpcbPcieRowstreamIngressM25AttentionLn2YosysJson;
          seed = 15;
          freqMHz = 100;
          prePackScripts = [ task6YpcbUberDdr3ClockConstraints ];
          nextpnrExtraArgs = "--no-tmdriv";
        ...
        task6YpcbPcieRowstreamIngressM25AttentionLn2Pnr100Bitstream = mkBitstream {
          name = "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-pnr100";
          fasm = task6YpcbPcieRowstreamIngressM25AttentionLn2Pnr100Fasm;
          framesBase = "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-pnr100";
        };

        task6YpcbPcieRowstreamIngressM25AttentionLn2SeedBitstream = seed:
          let
            seedText = toString seed;
            fasm = mkFasm {
              name = "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-pnr100-seed${seedText}";
              xdc = "${task6Pcie7xSourceVivadoLane0Loc}/pcie_7x_ypcb_k480t.xdc";
              json = task6YpcbPcieRowstreamIngressM25AttentionLn2YosysJson;
              inherit seed;
              freqMHz = 100;
          ...
          mkBitstream {
            name = "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-pnr100-seed${seedText}";
            inherit fasm;
            framesBase = "task6-ypcb-pcie-rowstream-ingress-m2-5-attention-ln2-pnr100-seed${seedText}";
          };
        ...
        task6YpcbPcieDdr3IsolatedCommandBridgeFasm = mkFasm {
          ...
          json = task6YpcbPcieDdr3IsolatedCommandBridgeYosysJson;
          seed = 15;
          prePackScripts = [ task6YpcbUberDdr3ClockConstraints ];
          nextpnrExtraArgs = "--no-tmdriv";
        };

        task6YpcbPcieDdr3IsolatedCommandBridgeBitstream = mkBitstream {
          name = "task6-ypcb-pcie-ddr3-isolated-command-bridge";
          fasm = task6YpcbPcieDdr3IsolatedCommandBridgeFasm;
          framesBase = "task6-ypcb-pcie-ddr3-isolated-command-bridge";
        };
        ...
        task6YpcbPcieUberDdr3RowstreamLoaderBitstream = mkBitstream {
          name = "task6-ypcb-pcie-uberddr3-rowstream-loader";
        ...
        task6YpcbPcieUberDdr3RowstreamLoaderOnlySeed19Fasm = mkFasm {
          name = "task6-ypcb-pcie-uberddr3-rowstream-loader-only-seed19";
          xdc = task6YpcbPcieUberDdr3RowstreamLoaderXdc;
          json = task6YpcbPcieUberDdr3RowstreamLoaderOnlyYosysJson;
          seed = 19;
          prePackScripts = [ task6YpcbUberDdr3ClockConstraints ];
        ...
        task6YpcbPcieUberDdr3RowstreamLoaderOnlySeed19Bitstream = mkBitstream {
          name = "task6-ypcb-pcie-uberddr3-rowstream-loader-only-seed19";
          fasm = task6YpcbPcieUberDdr3RowstreamLoaderOnlySeed19Fasm;
...
EOF
        ...
        task6YpcbUberDdr3BistSeed15Fasm = mkFasm {
          name = "task6-ypcb-uberddr3-bist-seed15";
          xdc = task6YpcbUberDdr3BistXdc;
          json = task6YpcbUberDdr3BistYosysJson;
          seed = 15;
          freqMHz = 25;
        ...
        task6YpcbUberDdr3BistSeed15Bitstream = mkBitstream {
          name = "task6-ypcb-uberddr3-bist-seed15";
          fasm = task6YpcbUberDdr3BistSeed15Fasm;
        ...
        task6YpcbUberDdr3KnownGoodPrePlaceBelLocks =
          task6YpcbUberDdr3GeneratePrePlaceBelLocks { name = "known-good"; };

        task6YpcbUberDdr3KnownGoodClockPrePlaceBelLocks =
          task6YpcbUberDdr3GeneratePrePlaceBelLocks {
            name = "known-good-clock";
            scopes = [ "ddr3_clocks" ];
          };

        task6YpcbUberDdr3KnownGoodClockAndPhyPrePlaceBelLocks =
          task6YpcbUberDdr3GeneratePrePlaceBelLocks {
            name = "known-good-clock-and-phy";
            scopes = [
              "ddr3_clocks"
              "uberddr3_phy"
              "ddr3_board_pins"
        ...
        task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeed =
          seed:
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeedWithJson {
            seed = seed;
            json = task6YpcbUberDdr3RowstreamLoaderYosysJson;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedArtifacts =
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeed 15;

        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedArtifacts =
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeed 16;

        task6YpcbUberDdr3RowstreamLoaderSeed17ClockedArtifacts =
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeed 17;
        ...
        task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedArtifacts =
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeedWithJson {
            seed = 18;
        ...
        task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedArtifacts =
          let
            seedStr = toString 16;
            name = "task6-ypcb-uberddr3-rowstream-loader-1lane-seed${seedStr}-clocked";
            fasm = mkFasm {
              inherit name;
              xdc = task6YpcbUberDdr3BistXdc;
              json = task6YpcbUberDdr3RowstreamLoader1LaneYosysJson;
              seed = 16;
              freqMHz = 25;
              prePackScripts = [ task6YpcbUberDdr3ClockConstraints ];
            };
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed15ClockedArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedPlacedJson =
          task6YpcbUberDdr3RowstreamLoaderSeed15ClockedArtifacts.placedJson;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedPlacedJson =
          task6YpcbUberDdr3RowstreamLoaderSeed16ClockedArtifacts.placedJson;

        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed16ClockedArtifacts.bitstream;

        task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedFasm =
          task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedPlacedJson =
          task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedArtifacts.placedJson;

        task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedBitstream =
          task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedArtifacts.bitstream;

        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyArtifacts =
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeedWithPrePlace {
            seed = 16;
            suffix = "clocked-locked-clock-only";
            prePlaceLocks = task6YpcbUberDdr3KnownGoodClockPrePlaceBelLocks;
          };

        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockAndPhyArtifacts =
          task6YpcbUberDdr3ClockedRowstreamLoaderArtifactsForSeedWithPrePlace {
            seed = 16;
            suffix = "clocked-locked-clock-and-phy";
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockAndPhyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockAndPhyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockAndPhyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockAndPhyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockOnlyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockOnlyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockOnlyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockOnlyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockAndPhyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockAndPhyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockAndPhyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed15ClockedLockedClockAndPhyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockOnlyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockOnlyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockOnlyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockOnlyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockAndPhyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockAndPhyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockAndPhyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed17ClockedLockedClockAndPhyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed18ClockedLockedClockOnlyFasm =
          task6YpcbUberDdr3RowstreamLoaderSeed18ClockedLockedClockOnlyArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderSeed18ClockedLockedClockOnlyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed18ClockedLockedClockOnlyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed18ClockedLockedClockAndPhyBitstream =
          task6YpcbUberDdr3RowstreamLoaderSeed18ClockedLockedClockAndPhyArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed17ClockedPlacedJson =
          task6YpcbUberDdr3RowstreamLoaderSeed17ClockedArtifacts.placedJson;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed18ClockedPlacedJson =
          task6YpcbUberDdr3RowstreamLoaderSeed18ClockedArtifacts.placedJson;
        ...
        task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedFasm =
          task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedArtifacts.fasm;

        task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedPlacedJson =
          task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedArtifacts.placedJson;

        task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedBitstream =
          task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedArtifacts.bitstream;
        ...
        task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedPlacedJson = mkPlacedJson {
          name = "task6-ypcb-uberddr3-rowstream-loader-seed16-clocked-locked";
          xdc = task6YpcbUberDdr3BistXdc;
          json = task6YpcbUberDdr3RowstreamLoaderYosysJson;
          seed = 16;
        ...
        task6YpcbUberDdr3BistSeed17Bitstream = mkBitstream {
          name = "task6-ypcb-uberddr3-bist-seed17";
          fasm = task6YpcbUberDdr3BistSeed17Fasm;
          framesBase = "task6-ypcb-uberddr3-bist-seed17";
        };

        task6YpcbUberDdr3BistSeed18Fasm = mkFasm {
          name = "task6-ypcb-uberddr3-bist-seed18";
          xdc = task6YpcbUberDdr3BistXdc;
          json = task6YpcbUberDdr3BistYosysJson;
          seed = 18;
          freqMHz = 25;
        ...
        task6YpcbUberDdr3BistSeed18Bitstream = mkBitstream {
          name = "task6-ypcb-uberddr3-bist-seed18";
          fasm = task6YpcbUberDdr3BistSeed18Fasm;
          framesBase = "task6-ypcb-uberddr3-bist-seed18";
        };

        task6YpcbUberDdr3Bist1LaneSeed18Fasm = mkFasm {
          name = "task6-ypcb-uberddr3-bist-1lane-seed18";
          xdc = task6YpcbUberDdr3BistXdc;
          json = task6YpcbUberDdr3Bist1LaneYosysJson;
          seed = 18;
          freqMHz = 25;
        };

        task6YpcbUberDdr3Bist1LaneSeed18Bitstream = mkBitstream {
          name = "task6-ypcb-uberddr3-bist-1lane-seed18";
          fasm = task6YpcbUberDdr3Bist1LaneSeed18Fasm;
        ...
        task6M2EmbeddingLiveContextAttentionLn2PcieAccelSimMain =
          pkgs.runCommand "task6-m2-embedding-live-context-attention-ln2-pcie-accel-sim-main" {
            buildInputs = [ pkgs.verilator pkgs.gcc pkgs.gnumake ];
          } ''
            set -euo pipefail
            mkdir -p "$out/obj_dir"
            verilator --binary --timing --language 1800-2017 -Wno-fatal \
              ...
              -I${task6M2LnAttnLiveKvAllHeadsContextTbDataSv} \
              -I${task6M2EmbeddingBlockInputTbDataSv} \
              -top task6_m2_embedding_live_context_attention_ln2_pcie_accel_tb \
              -Mdir "$out/obj_dir" -o sim_main \
              ${./fpga/rtl/task6_m2_embedding_block_input_accel_top.sv} \
              ${./fpga/rtl/task6_m2_ln_attn_live_kv_all_heads_context_accel_top.sv} \
              ${./fpga/rtl/task6_m2_first_token_attention_out_proj_accel_top.sv} \
        ...
        task6M2EmbeddingLiveContextAttentionLn2PcieAccelSvSim =
          pkgs.runCommand "task6-m2-embedding-live-context-attention-ln2-pcie-accel-sv-sim.json" {
            buildInputs = [ pkgs.gawk pkgs.gnugrep ];
          } ''
            set -euo pipefail
            ${task6M2EmbeddingLiveContextAttentionLn2PcieAccelSimMain}/obj_dir/sim_main 2>&1 | tee sim.log
            pass_line="$(${pkgs.gnugrep}/bin/grep -Eo 'PASS: task6 M2.5 embedding live-context attention LN2 PCIe wrapper cycles [0-9]+ ln2_checksum [0-9a-f]+ ln2_sample0 [0-9a-f]+ ln2_sample1 [0-9a-f]+ debug [0-9a-f]+ debug1 [0-9a-f]+ debug2 [0-9a-f]+ debug3 [0-9a-f]+ provenance [0-9a-f]+' sim.log | tail -n1 || true)"
            if [ -z "$pass_line" ]; then
              echo "task6-m2-embedding-live-context-attention-ln2 PCIe wrapper SV simulation did not produce a PASS line" >&2
              exit 1
            fi
            cycles="$(${pkgs.gawk}/bin/awk '{print $10}' <<<"$pass_line")"
            ln2_checksum="$(${pkgs.gawk}/bin/awk '{print $12}' <<<"$pass_line")"
            ln2_sample0="$(${pkgs.gawk}/bin/awk '{print $14}' <<<"$pass_line")"
            ln2_sample1="$(${pkgs.gawk}/bin/awk '{print $16}' <<<"$pass_line")"
            debug="$(${pkgs.gawk}/bin/awk '{print $18}' <<<"$pass_line")"
            debug1="$(${pkgs.gawk}/bin/awk '{print $20}' <<<"$pass_line")"
            debug2="$(${pkgs.gawk}/bin/awk '{print $22}' <<<"$pass_line")"
            debug3="$(${pkgs.gawk}/bin/awk '{print $24}' <<<"$pass_line")"
            provenance="$(${pkgs.gawk}/bin/awk '{print $26}' <<<"$pass_line")"
            cat > "$out" <<EOF
            {
              "status": "PASS",
              "block_scope": "pcie-bar-token-id-embedding-live-context-attention-out-projection-residual-ln2",
              "input_boundary": "pcie_bar_token_ids",
              "embedding_position_add_rtl": true,
              "pcie_bar_scope": true,
      ...
      in {
        ...
        in {
          ...
          task6-m2-embedding-live-context-full-block-pcie-accel-sv-sim =
            task6M2EmbeddingLiveContextFullBlockPcieAccelSvSim;
          task6-m2-embedding-live-context-attention-ln2-pcie-accel-sim-main =
            task6M2EmbeddingLiveContextAttentionLn2PcieAccelSimMain;
          ...
          task6-ypcb-pcie-rowstream-ingress-dummy-yosys-json =
            task6YpcbPcieRowstreamIngressDummyYosysJson;
          ...
          task6-m2-5-attention-ln2-pnr100-bitstream =
            task6YpcbPcieRowstreamIngressM25AttentionLn2Pnr100Bitstream;
          task6-m2-5-attention-ln2-pnr100-seed16-bitstream =
            task6YpcbPcieRowstreamIngressM25AttentionLn2SeedBitstream 16;
          task6-m2-5-attention-ln2-pnr100-seed17-bitstream =
            task6YpcbPcieRowstreamIngressM25AttentionLn2SeedBitstream 17;
          task6-m2-5-attention-ln2-pnr100-seed18-bitstream =
            task6YpcbPcieRowstreamIngressM25AttentionLn2SeedBitstream 18;
          task6-m2-5-attention-ln2-pnr100-seed19-bitstream =
            task6YpcbPcieRowstreamIngressM25AttentionLn2SeedBitstream 19;
          ...
          task6-ypcb-pcie-ddr3-isolated-command-bridge-bitstream =
            task6YpcbPcieDdr3IsolatedCommandBridgeBitstream;
          ...
          task6-ypcb-uberddr3-bist-yosys-json =
            task6YpcbUberDdr3BistYosysJson;
          task6-ypcb-uberddr3-bist-1lane-yosys-json =
            task6YpcbUberDdr3Bist1LaneYosysJson;
          ...
          task6-ypcb-uberddr3-rowstream-loader-boot-isolated-yosys-json =
            task6YpcbUberDdr3RowstreamLoaderBootIsolatedYosysJson;
          task6-ypcb-uberddr3-rowstream-loader-bist-clock-yosys-json =
            task6YpcbUberDdr3RowstreamLoaderBistClockYosysJson;
          ...
          task6-ypcb-uberddr3-bist-seed15-fasm =
          ...
          task6-ypcb-uberddr3-rowstream-loader-seed15-clocked-fasm =
            task6YpcbUberDdr3RowstreamLoaderSeed15ClockedFasm;
          task6-ypcb-uberddr3-rowstream-loader-seed15-clocked-bitstream =
            task6YpcbUberDdr3RowstreamLoaderSeed15ClockedBitstream;
          ...
          task6-ypcb-uberddr3-rowstream-loader-seed16-clocked-bitstream =
            task6YpcbUberDdr3RowstreamLoaderSeed16ClockedBitstream;
          task6-ypcb-uberddr3-rowstream-loader-1lane-seed16-clocked-fasm =
            task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedFasm;
          task6-ypcb-uberddr3-rowstream-loader-1lane-seed16-clocked-bitstream =
            task6YpcbUberDdr3RowstreamLoader1LaneSeed16ClockedBitstream;
          ...
          task6-ypcb-uberddr3-known-good-clock-pre-place-bel-locks =
            task6YpcbUberDdr3KnownGoodClockPrePlaceBelLocks;
          task6-ypcb-uberddr3-known-good-clock-and-phy-pre-place-bel-locks =
            task6YpcbUberDdr3KnownGoodClockAndPhyPrePlaceBelLocks;
          task6-ypcb-uberddr3-rowstream-loader-seed16-clocked-locked-clock-only-fasm =
            task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyFasm;
          task6-ypcb-uberddr3-rowstream-loader-seed16-clocked-locked-clock-only-bitstream =
            task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedClockOnlyBitstream;
          ...
          task6-ypcb-uberddr3-rowstream-loader-seed16-clocked-placed-json =
            task6YpcbUberDdr3RowstreamLoaderSeed16ClockedPlacedJson;
          task6-ypcb-uberddr3-rowstream-loader-seed16-clocked-locked-placed-json =
            task6YpcbUberDdr3RowstreamLoaderSeed16ClockedLockedPlacedJson;
          task6-ypcb-uberddr3-rowstream-loader-seed16-bel-locks-json =
            task6YpcbUberDdr3RowstreamLoaderSeed16BelLocksJson;
          ...
          task6-ypcb-uberddr3-rowstream-loader-seed17-clocked-fasm =
            task6YpcbUberDdr3RowstreamLoaderSeed17ClockedFasm;
          task6-ypcb-uberddr3-rowstream-loader-seed17-clocked-bitstream =
            task6YpcbUberDdr3RowstreamLoaderSeed17ClockedBitstream;
          ...
          task6-ypcb-uberddr3-rowstream-loader-boot-isolated-seed18-clocked-placed-json =
            task6YpcbUberDdr3RowstreamLoaderBootIsolatedSeed18ClockedPlacedJson;
          task6-ypcb-uberddr3-rowstream-loader-bist-clock-seed18-clocked-fasm =
            task6YpcbUberDdr3RowstreamLoaderBistClockSeed18ClockedFasm;
          ...
          task6-ypcb-uberddr3-bist-seed17-bitstream =
            task6YpcbUberDdr3BistSeed17Bitstream;
          task6-ypcb-uberddr3-bist-seed18-fasm =
            task6YpcbUberDdr3BistSeed18Fasm;
          task6-ypcb-uberddr3-bist-seed18-bitstream =
            task6YpcbUberDdr3BistSeed18Bitstream;
          task6-ypcb-uberddr3-bist-1lane-seed18-fasm =
