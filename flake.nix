  ...
  outputs = inputs@{ nixpkgs, nixpkgs-llvm21, flake-utils, yosys, circt-nix
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        mkTorchMlir = applyTask3RfpPatches:
          pkgsLlvm21.callPackage ./torch-mlir.nix {
        ...
        synthStagePackages = mkSynthStagePackages "tiny-stories-1m-utilization"
          ...
          tinyStories1mBaselineFloatUtilizationStages // mkSynthStagePackages
