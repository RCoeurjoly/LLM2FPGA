...
This reviewer path is the explicit =tiny-stories-1m-baseline-float= route.
The repo still contains separate PT2E and TorchAO experiments, but they are
not the current Task 3 RfP reviewer claim.
