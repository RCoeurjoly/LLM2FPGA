...
- Task 3 deliverable index and per-file reproduction map: [[file:deliverables/README.org]]
- Project plan: [[file:docs/project-plan_v2.org]]

If you only read one thing, read:
1. [[file:deliverables/1c-selected_route.org]]
2. [[file:deliverables/README.org]]
3. [[file:deliverables/3e-tiny-stories-1m-resource-report.org]]
