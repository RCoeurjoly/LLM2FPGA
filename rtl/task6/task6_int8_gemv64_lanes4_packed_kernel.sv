...
module task6_int8_gemv64_lanes4_packed_kernel #(
  ...
  logic [PACKED_WEIGHT_ADDR_WIDTH - 1:0] in_index_ext_w;
  ...
  assign packed_weight_addr = packed_base_q + in_index_ext_w;
  assign emit_lane_next_w = emit_lane_q + 1'b1;
  assign in_index_ext_w = PACKED_WEIGHT_ADDR_WIDTH'(in_index_q);
