...
"""PT2E static-quantized attention-block reproducer without layer norm."""
...
class QuantAttentionBlockNoLayerNorm(torch.nn.Module):
...
def export_program(model_path: str | None) -> torch.export.ExportedProgram:
    del model_path
    model = QuantAttentionBlockNoLayerNorm().eval()
