...
def backend_quantizer_entrypoints(backend: str) -> list[str]:
    mapping = {
        ...
        "cadence": [
            ...
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceFusedConvReluQuantizer",
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceNopQuantizer",
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceRmsNormNopQuantizer",
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceW8A32MixedQuantizer",
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceWakeWordQuantizer",
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceWith16BitConvActivationsQuantizer",
            ...
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceWithLayerNormQuantizer",
            "executorch.backends.cadence.aot.quantizer.quantizer.CadenceWithSoftmaxQuantizer",
