...
for name, mhz in [
    ...
    ("clk200_raw", 200.0),
    ("ref_clk", 200.0),
    ("rowstream_ddr3.controller_clk", 50.0),
    ("rowstream_ddr3.clk25_raw", 66.667),
    ("rowstream_ddr3.clk100_raw", 200.0),
    ("rowstream_ddr3.clk100_90_raw", 200.0),
    ("rowstream_ddr3.ddr3_clk", 200.0),
    ("rowstream_ddr3.ddr3_clk_90", 200.0),
    ("rowstream_ddr3.clk200_raw", 200.0),
    ("rowstream_ddr3.ref_clk", 200.0),
    ("impl.rowstream_ddr3.controller_clk", 50.0),
    ("impl.rowstream_ddr3.clk25_raw", 66.667),
    ("impl.rowstream_ddr3.clk100_raw", 200.0),
    ("impl.rowstream_ddr3.clk100_90_raw", 200.0),
    ("impl.rowstream_ddr3.ddr3_clk", 200.0),
    ("impl.rowstream_ddr3.ddr3_clk_90", 200.0),
