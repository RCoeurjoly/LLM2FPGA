...
set out_dir [file normalize artifacts/task6/vivado-pcie-y26-lane0-no-reset-oracle]
set overlay_dir [file join $out_dir overlay]
file mkdir $overlay_dir

set top_overlay [file join $overlay_dir pcie_7x_top_aximm_ypcb_480t_y26_no_reset.v]
...
write_bitstream -force $out_dir/ypcb_pcie_y26_lane0_no_reset_oracle.bit
