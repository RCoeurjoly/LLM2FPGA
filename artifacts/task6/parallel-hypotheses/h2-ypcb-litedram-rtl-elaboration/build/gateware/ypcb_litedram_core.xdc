...
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[0]}]

# ddram:0.dqs_p
set_property LOC AM17 [get_ports {ddram_dqs_p[1]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[1]}]

# ddram:0.dqs_p
set_property LOC AP21 [get_ports {ddram_dqs_p[2]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[2]}]

# ddram:0.dqs_p
set_property LOC AH20 [get_ports {ddram_dqs_p[3]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[3]}]

# ddram:0.dqs_p
set_property LOC AK33 [get_ports {ddram_dqs_p[4]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[4]}]

# ddram:0.dqs_p
set_property LOC AG33 [get_ports {ddram_dqs_p[5]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[5]}]

# ddram:0.dqs_p
set_property LOC AE34 [get_ports {ddram_dqs_p[6]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[6]}]

# ddram:0.dqs_p
set_property LOC AE27 [get_ports {ddram_dqs_p[7]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_p[7]}]

# ddram:0.dqs_n
set_property LOC AK17 [get_ports {ddram_dqs_n[0]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[0]}]

# ddram:0.dqs_n
set_property LOC AM18 [get_ports {ddram_dqs_n[1]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[1]}]

# ddram:0.dqs_n
set_property LOC AP22 [get_ports {ddram_dqs_n[2]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[2]}]

# ddram:0.dqs_n
set_property LOC AJ20 [get_ports {ddram_dqs_n[3]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[3]}]

# ddram:0.dqs_n
set_property LOC AL33 [get_ports {ddram_dqs_n[4]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[4]}]

# ddram:0.dqs_n
set_property LOC AH33 [get_ports {ddram_dqs_n[5]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[5]}]

# ddram:0.dqs_n
set_property LOC AF34 [get_ports {ddram_dqs_n[6]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[6]}]

# ddram:0.dqs_n
set_property LOC AE28 [get_ports {ddram_dqs_n[7]}]
set_property IOSTANDARD SSTL15 [get_ports {ddram_dqs_n[7]}]
