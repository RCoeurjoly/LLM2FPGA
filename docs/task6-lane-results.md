...
| What is the current mainline execution order? | Freeze StreamTensor-lite references; keep the bounded DDR3 pass recorded as partial-shell; keep the LSQ A/B recorded as spent negative; keep the broader PT2E-static full-model route as reference-only because the direct extracted-op parity slice is a no-op; require a new quant/storage hypothesis before any new kernel design or heavier replay | Deep research audit plus the 2026-04-24 LSQ and PT2E-static extracted-op passes | decided |
