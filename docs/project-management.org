...
** TODO_NEXT First draft
- State "TODO_NEXT"  from              [2025-11-03 Mon 16:50]
*** TODO_NEXT Torch-MLIR + CIRCT
- State "TODO_NEXT"  from              [2025-11-23 Sun 15:07]
  repo: my fork of hot-chips-2022-pytorch-circt-hls-demo/
  nix shell "github:NixOS/nixpkgs/ee09932cedcef15aaf476f9343d1dea2cb77e261#llvmPackages_21.mlir" -c ./demo2.sh
...
- State "TODO_NEXT"  from              [2025-11-24 Mon 16:14]
  func.func @main(%arg0: memref<4x4xi32, strided<[?, ?], offset: ?>>, %arg1: memref<4x4xi32, strided<[?, ?], offset: ?>>, %arg2: memref<4x4xi32>) {
                  ^
*** TODO_NEXT LoopLynx: https://github.com/zjnyly/LoopLynx?tab=readme-ov-file
...
*** TODO_NEXT HLSTransform: https://github.com/HLSTransform/submission
- State "TODO_NEXT"  from              [2025-11-03 Mon 12:06]
2 years old?
