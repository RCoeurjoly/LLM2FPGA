...
The succesful result is an unintegrated RTL netlist of the model (RTLIL or Verilog/SystemVerilog) and synthesis resource estimates.

Otherwise, bottleneck report identifying unsupported operators, failing passes, or performance pathologies in the toolchain
