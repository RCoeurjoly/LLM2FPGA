...
** TODO_NEXT Lowering of small LLM to RTL [4/6]
- State "TODO_NEXT"  from              [2026-01-27 Tue 10:54]
*** DONE Title
...
Frozen TinyStories-1M source reference (model identifier + pinned revision) and a fixed export input (prompt/input_ids), both recorded in-repo.
**** Subtask 2
