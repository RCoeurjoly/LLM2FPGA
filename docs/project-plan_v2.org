...
** 2) End-to-End semantic equivalence of a PyTorch kernel to synthesizable RTL
*** Goal:
...
** 3) Lowering of small LLM to RTL
*** Goal:
...
** 4) FPGA integration and hardware validation
*** Goal:
...
** 5) Scaling and resource usage analysis
*** Goal:
...
** 6) Resource usage reduction strategies
*** Goal:
