...
This includes:
- Integrating the generated RTL with minimal glue logic under a defined host-facing interface,
- Completing full FPGA synthesis and place-and-route,
- Executing the design on hardware for a fixed input,
