...
- State "TODO"       from              [2026-02-16 Mon 22:17]
  ...
  Current branch evidence on 2026-04-11:
  the standard baseline-float route reaches emitted SystemVerilog, reaches
  Yosys, and emits RTLIL plus a Yosys stat report.
  - =tiny-stories-1m-baseline-float-il= succeeds and emits RTLIL.
  - =tiny-stories-1m-baseline-float-yosys-stat= succeeds with measured SV
    bundle and design-memory metrics: `467` files, `6,971,927` lines in
    =main.sv=, `12,738,203` design cells, `327` design memories,
    `433,040,128` total memory bits, and `411,705,344` bits in the four
    largest memories.
