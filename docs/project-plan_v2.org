...
** TODO_NEXT Tracer-Bullet PyTorch and RTL Equivalence (Matmul Kernel)
...
** TODO_NEXT Lowering of small LLM to RTL
...
** TODO_NEXT System integration and hardware demonstration
...
** TODO_NEXT Resource usage reduction strategies
