...
Use the `expected` value printed by the checker output for comparisons.
...
- `led_3bits_tri_o[1]`: PASS latched (`in2_st0 == expected` from checker)
...
- final report: `deliverables/2e-report.org`
- evidence folder: `deliverables/2e/`
