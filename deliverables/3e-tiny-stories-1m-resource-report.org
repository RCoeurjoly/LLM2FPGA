...
Yosys/Xilinx mapping, writes mapped JSON, and derives utilization
numbers from that mapped JSON.
...
mapped Yosys estimate. nextpnr-xilinx was attempted, but it runs out of
