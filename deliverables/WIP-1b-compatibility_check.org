...
| TMMA         | https://github.com/RCoeurjoly/MatMul_SA                  | 5db3d530d6e7362192de218a2d60d5786a0a01c1 | PandA-bambu → Verilog     | ok (HLS) | Vitis headers ok via bambu; large netlist in Yosys  | deliverables/1b/tmma_bambu_yosys.log   |
| LoopLynx     | https://github.com/zjnyly/LoopLynx                       | <hash>                                   | Vendor (XRT/Vitis/Vivado) | rejected | Requires XRT/Vitis/Vivado; no practical open flow   | deliverables/1b/looplynx_notes.org     |
| HLSTransform | https://github.com/HLSTransform/submission               | <hash>                                   | AWS EC2/FPGA AMI/S3       | rejected | Cloud-only reference flow, contradicts local goal   | deliverables/1b/hlstransform_notes.org |
| allo         | https://github.com/cornell-zhang/allo                    | <hash>                                   | MLIR IR + mlir-opt        | ok (IR)  | MLIR IR canonicalizes; FPGA backend needs Vitis HLS | deliverables/1b/allo_mlir.log          |
