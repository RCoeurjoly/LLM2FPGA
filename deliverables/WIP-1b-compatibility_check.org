...
| Project      | Repo URL                                                 | Commit                                   | Flow / Tooling            | Status   | Main blockage / note                                | Log file                               |
|--------------+----------------------------------------------------------+------------------------------------------+---------------------------+----------+-----------------------------------------------------+----------------------------------------|
| deepwok/MASE | https://github.com/RCoeurjoly/mase/tree/RCoeurjoly/flake | bd0364fc2e6e789511d25482dcd2daa6e5605043 | Yosys + slang (SV)        | partial  | Missing net_*_source modules in generated top.sv    | deliverables/1b/mase_yosys.log         |
| TMMA         | https://github.com/RCoeurjoly/MatMul_SA                  | 5db3d530d6e7362192de218a2d60d5786a0a01c1 | PandA-bambu to Verilog    | ok (HLS) | Vitis headers ok via bambu; large netlist in Yosys  | deliverables/1b/tmma_bambu_yosys.log   |
| LoopLynx     | https://github.com/zjnyly/LoopLynx                       | e74592af31d015369dd176077252914c0ed267fe | Vendor (XRT/Vitis/Vivado) | rejected | Requires XRT/Vitis/Vivado; no practical open flow   | deliverables/1b/looplynx_notes.org     |
| HLSTransform | https://github.com/HLSTransform/submission               | 5c7b068a1d6c6709163e2cec28cedea3ed2d7ca9 | AWS EC2/FPGA AMI/S3       | rejected | Cloud-only reference flow, contradicts local goal   | deliverables/1b/hlstransform_notes.org |
| allo         | https://github.com/cornell-zhang/allo                    | 89d1ae33ced34df5d66be3ef2f47acee6742162a | MLIR IR + mlir-opt        | ok (IR)  | MLIR IR canonicalizes; FPGA backend needs Vitis HLS | deliverables/1b/allo_mlir.log          |
