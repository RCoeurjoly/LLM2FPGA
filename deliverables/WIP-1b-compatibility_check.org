...
| Status           | Project            | Repo URL                                                            | Commit                                   | Flow / Tooling                   | If HLS is used, can C/C++ be compiled by FOSS HLS? | Can HDL be parsed by Yosys/yosys-slang?                                                                               | Main blockage / note                                                            | logs |
|------------------+--------------------+---------------------------------------------------------------------+------------------------------------------+----------------------------------+----------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+------|
| partial          | deepwok/MASE       | https://github.com/RCoeurjoly/mase/tree/RCoeurjoly/flake            | bd0364fc2e6e789511d25482dcd2daa6e5605043 | Yosys + slang (SV)               |                                                    | HDL is generated and partially parsed by yosys-slang, but elaboration fails due to missing modules (generator issue). | Missing net_*_source modules in generated top.sv                                |      |
| ok (RTL via HLS) | TMMA               | https://github.com/RCoeurjoly/MatMul_SA                             | 5db3d530d6e7362192de218a2d60d5786a0a01c1 | PandA-bambu to Verilog           | yes, via PandA-bambu                               | yes, via Yosys.                                                                                                       | Vitis headers ok via bambu; large netlist in Yosys                              |      |
| rejected         | LoopLynx           | https://github.com/zjnyly/LoopLynx                                  | e74592af31d015369dd176077252914c0ed267fe | Vendor (XRT/Vitis/Vivado)        |                                                    |                                                                                                                       | Requires XRT/Vitis/Vivado; no practical open flow                               |      |
| rejected         | HLSTransform       | https://github.com/HLSTransform/submission                          | 5c7b068a1d6c6709163e2cec28cedea3ed2d7ca9 | AWS EC2/FPGA AMI/S3              |                                                    |                                                                                                                       | Cloud-only reference flow, contradicts local goal                               |      |
...
| ok (RTL)         | Torch-MLIR + CIRCT | https://github.com/RCoeurjoly/hot-chips-2022-pytorch-circt-hls-demo | 364ac72935304464a49cb936ae5fd012347ec7ce | Torch-MLIR + CIRCT + yosys-slang |                                                    |                                                                                                                       | Torch-MLIR + CIRCT + yosys-slang pipeline demostrated, GPT2 to MLIR demostrated |      |
